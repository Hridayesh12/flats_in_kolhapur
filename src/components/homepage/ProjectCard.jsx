    ...
    >
      ...
      >
        <div className="w-full flex items-start justify-start">
          <p className="text-base font-bold leading-none flex flex-wrap overflow-hidden whitespace-nowrap text-left">
            {name.toUpperCase()}
          </p>
        </div>
        <div className="w-full flex items-start justify-around ">
          ...
          <p className="text-base leading-none max-w-[45%] min-w-[45%] flex items-end flex-wrap">
            ₹ {price}
            <p className="text-[10px] leading-3 text-base-900">&nbsp;onwards</p>
          </p>
        </div>
        <div className="w-full flex items-end justify-around">
          <p className="text-base leading-none max-w-[50%] min-w-[55%] flex items-end flex-wrap">
            {bhk}{" "}
            <p className="text-[10px] leading-[11px] text-base-900">
              &nbsp;posted by owner
            </p>
          </p>
