...
import { fetchProjectByDomain, handleDownload, postLeadToProject } from "../services/projectService";
...
function WebsitePage() {
	...
	const fetchProject = async (domain) => {
		try {
			...
			const fetchedProject = {
				...
				location: projectData.projectId.location.area + ", " + projectData.projectId.city,
	...
	return (
		<>
			{project ? (
				<div className='px-4 sm:px-8 md:px-16 pb-5'>
					<Helmet>
					...
					<div
						className='grid grid-cols-1 md:grid-cols-3 gap-2 my-2 borde-2 border-solid border-base-600'>
					...
					<button onClick={()=>{handleDownloadBrochure()}}  className='bg-base-600 text-base-100 mt-10 text-white py-2 px-4 rounded mb-2'>
						Download
					</button>
